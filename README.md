...
## Results
### CPU:
![CPU results](https://github.com/Beantonia/parhuzamos_eszkozok/blob/main/CPU_results.png) ![CPU results](https://github.com/Beantonia/parhuzamos_eszkozok/blob/main/GPU_results.png)
